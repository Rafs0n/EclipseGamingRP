...
Config.SellItems = { -- Selling Prices
	...
	['diamond_necklace'] = 2500,
	['emerald_necklace'] = 1500,
	['ruby_necklace'] = 2000,
	['sapphire_necklace'] = 1750,
...
Config.Items = {
    ...
    items = {
	[1] = { name = "water_bottle", price = 2, amount = 99999, info = {}, type = "item", slot = 1, },
	[2] = { name = "sandwich", price = 2, amount = 99999, info = {}, type = "item", slot = 2, },
	[3] = { name = "bandage", price = 25, amount = 99999, info = {}, type = "item", slot = 3, },
	[4] = { name = "weapon_flashlight", price = 30, amount = 99999, info = {}, type = "item", slot = 4, }, 
	[5] = { name = "drill",	price = 1000, amount = 99999, info = {}, type = "item", slot = 5, }, 
	[6] = { name = "handdrill",	price = 500, amount = 99999, info = {}, type = "item",	slot = 6, },
	[7] = { name = "drillbit", price = 50, amount = 99999,	info = {}, type = "item", slot = 7, }, }		
}