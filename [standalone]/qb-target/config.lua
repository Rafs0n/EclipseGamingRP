...
Config.BoxZones = {
    ...
    ["Clothing"] = {
        name = "PoliceClothing",
        coords = vector3(462.27, -995.44, 30.690),
        length = 5.0,
        width = 0.4,
        heading = 270,
        debugPoly = false,
    ...
    ["Boosting"] = {
        name = "Boosting",
        coords = vector3(949.58, -966.61, 39.51),
        length = 0.8,
        width = 0.4,
        heading = 1,
        debugPoly = false,
        ...
        options = {
            {
                type = "client",
                event = "EG-Shops:client:OpenBoostingShop",
                icon = "fas fa-car", 
                label = "Whats Up?",
            }
        },
    ...
    ["Police-Stash"] = {
        name = "Police-Stash",
        coords = vector3(461.92, -1000.14, 30.69),
        length = 0.4,
        width = 4.6,
        heading = 0,
        debugPoly = false,
...
Config.TargetModels = {
	...
	["Gun-Guy"] = {
        ...
        options = {
            {
                type = "client",
                event = "EG-Shops:client:OpenGunShop",
                icon = "fas fa-times", 
                label = "Im Your Guy",
            }
        },
...
Config.Peds = {
    ...
    { 
        ...
        coords = vector4(5133.41, -4614.65, 1.43, 345.7),
        gender = 'male',
        freeze = true,
        invincible = true,
        blockevents = true,
	...
	{ 
        ...
        coords = vector4(887.83, -3200.88, -99.2, 27.09),
        gender = 'male',
        freeze = true,
        invincible = true,
        blockevents = true,
	...
	{ 
        ...
        coords = vector4(949.54, -966.62, 38.51, 267.73),
        gender = 'male',
        freeze = true,
        invincible = true,
        blockevents = true,
    ...
    { 
        ...
        coords = vector4(480.39, -996.7, 29.69, 85.98),
        gender = 'male',
        freeze = true,
        invincible = true,
        blockevents = true,
    ...
    { 
        model = 'cs_casey',
        coords = vector4(472.51, -991.22, 25.27, 285.28),
        gender = 'male',
        freeze = true,
        invincible = true,
        blockevents = true,
